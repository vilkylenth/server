...
#define GOSSIP_ITEM_DEMITRIAN1 "关于它你知道些什么？."
...
#define GOSSIP_ITEM_DEMITRIAN7 "那么，拉格纳罗斯有做了什么？."
...
#define GOSSIP_ITEM_SEEK1 "我在打听有关娜塔莉亚的消息。."

#define GOSSIP_ITEM_RUTGAR2 "那听起来很危险。."
#define GOSSIP_ITEM_RUTGAR3 "你怎么做的。."
#define GOSSIP_ITEM_RUTGAR4 "谁？."
#define GOSSIP_ITEM_RUTGAR5 "女人会那样做。她有什么要求？."
#define GOSSIP_ITEM_RUTGAR6 "什么意思？."
#define GOSSIP_ITEM_RUTGAR7 "接下来发生了什么？."

#define GOSSIP_ITEM_FRANKAL11 "好的，请继续。."
#define GOSSIP_ITEM_FRANKAL12 "什么语言？."
#define GOSSIP_ITEM_FRANKAL13 "祭司袭击了你？！."
#define GOSSIP_ITEM_FRANKAL14 "关于这事，我想我应该问问猴子。."
...
struct npc_prince_thunderaanAI : public ScriptedAI
{
	...
	void Aggro(Unit* pWho)
	{
		if (!engaged)
		{
			m_creature->MonsterYell("我的力量是混乱毁灭，这些凡人竟然试图闯入我的领域，真是可笑。.", 0);
			engaged = true;
		}
	}
...
struct npc_colossusAI : public ScriptedAI
{
	...
	void UpdateAI(const uint32 uiDiff)
	{
		...
		if (m_uiColossalSmashTimer < uiDiff)
		{
			...
			{
				m_creature->MonsterTextEmote("巨甲虫准备发动甲虫击碎。.", NULL);
		...
		{
			m_creature->MonsterTextEmote("巨甲虫发动了猛烈攻击。.", NULL);
			m_uiColossalSmashEmoteTimer = 0;
		}
		else
